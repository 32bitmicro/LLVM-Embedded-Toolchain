...
bare-metal LLVM based toolchain targeting MCUs based on:
* clang + llvm
* lld
* libc++abi
* libc++
...
variouse architecture families from Armv6-M and newer, RISC-V and AVR. The toolchain 
follows the ABIfor the respective architecture and attempts to provide typical features 
needed for embedded and realtime operating systems.
...
(This requirement will be removed in LLVM Embedded Toolchain 17.)

Prior to LLVM Embedded Toolchain 17, on macOS the toolchain binaries
...
See [Migrating from GNU Toolchain](https://github.com/32bitmicro/LLVM-Embedded-Toolchain/blob/main/docs/migrating.md)
for advice on using LLVM Embedded Toolchain with existing projects relying on the GNU Toolchain.
